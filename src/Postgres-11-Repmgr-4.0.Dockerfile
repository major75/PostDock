...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/repmgr-common_5.2.0-1.pgdg%2B1_all.deb" 
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/postgresql-$PG_MAJOR-repmgr_5.2.0-1.pgdg%2B1_amd64.deb" 
